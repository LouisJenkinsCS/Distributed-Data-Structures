...
static void chpl__init_LocaleModel(int64_t _ln,
  ...
  chpl____wide__ref__domain_DefaultRectangularDom_1_int64_t_F chpl_macro_tmp_666;
  chpl____wide__ref__domain_DefaultRectangularDom_1_int64_t_F chpl_macro_tmp_667;
  ...
  *(refIndentLevel) += INT64(1);
  ...
  chpl_macro_tmp_665.addr = _ref_tmp_;
  T2 = chpl_macro_tmp_665;
  chpl_macro_tmp_666.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_666.addr = &ret_tmp3;
  T3 = chpl_macro_tmp_666;
  ...
  chpl_macro_tmp_667.addr = _ref_tmp_2;
  T4 = chpl_macro_tmp_667;
...
static void chpl__auto_destroy_LocaleModel(chpl____wide_LocaleModel this12) {
  ...
  chpl____wide_AbstractLocaleModel chpl_macro_tmp_669;
  chpl____wide_locale chpl_macro_tmp_670;
  chpl____wide__ref_atomic_int64 chpl_macro_tmp_671;
  chpl____wide__ref_atomic_int_least64_t chpl_macro_tmp_672;
  chpl____wide__ref_atomic_int_least64_t chpl_macro_tmp_673;
  chpl_macro_tmp_668.locale = (&this12)->locale;
  chpl_macro_tmp_668.addr = &(((&this12)->addr)->local_name);
  _field_destructor_tmp_ = chpl_macro_tmp_668;
  deinit44(_field_destructor_tmp_);
  chpl_macro_tmp_669.locale = (&this12)->locale;
  chpl_macro_tmp_669.addr = ((AbstractLocaleModel)((&this12)->addr));
  _parent_destructor_tmp_ = chpl_macro_tmp_669;
  chpl_macro_tmp_670.locale = (&_parent_destructor_tmp_)->locale;
  chpl_macro_tmp_670.addr = ((locale)((&_parent_destructor_tmp_)->addr));
  _parent_destructor_tmp_2 = chpl_macro_tmp_670;
  chpl_macro_tmp_671.locale = (&_parent_destructor_tmp_2)->locale;
  chpl_macro_tmp_671.addr = &(((&_parent_destructor_tmp_2)->addr)->runningTaskCounter);
  _field_destructor_tmp_2 = chpl_macro_tmp_671;
  chpl_macro_tmp_672.locale = (_field_destructor_tmp_2).locale;
  chpl_macro_tmp_672.addr = &(((_field_destructor_tmp_2).addr)->_v);
  call_tmp2 = chpl_macro_tmp_672;
  T = (&call_tmp2)->addr;
  atomic_destroy_int_least64_t(T);
  chpl_macro_tmp_673.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_673.addr = T;
  call_tmp2 = chpl_macro_tmp_673;
  return;
}
...
static LocaleModel LocaleModel2(chpl____wide_locale parent_loc) {
  ...
  chpl_bool T;
  chpl_bool T2;
  chpl____wide__ref_chpl_bool chpl_macro_tmp_674;
  ...
  chpl_macro_tmp_674.locale = (&doneCreatingLocales)->locale;
  chpl_macro_tmp_674.addr = &(((&doneCreatingLocales)->addr)->value);
  chpl_gen_comm_get(((void*)(&T2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_674).locale), INT64(0), INT32(0)), (chpl_macro_tmp_674).addr, sizeof(chpl_bool), -1, COMMID(0), INT64(38), INT64(48));
  T = T2;
  if (T) {
...
static int64_t chpl_id3(chpl____wide_LocaleModel this12) {
  int64_t ret;
  int64_t T;
  chpl____wide__ref_int64_t chpl_macro_tmp_675;
  chpl_macro_tmp_675.locale = (&this12)->locale;
  chpl_macro_tmp_675.addr = &(((&this12)->addr)->_node_id);
  chpl_gen_comm_get(((void*)(&T)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_675).locale), INT64(0), INT32(0)), (chpl_macro_tmp_675).addr, sizeof(int64_t), -1, COMMID(0), INT64(81), INT64(24));
  ret = T;
  return ret;
}
...
static RootLocale RootLocale2(void) {
  ...
  chpl____wide_DefaultRectangularDom_1_int64_t_F chpl_macro_tmp_678;
  chpl____wide__nilType chpl_macro_tmp_679;
  chpl____wide_DefaultRectangularArr_locale_1_int64_t_F_int64_t chpl_macro_tmp_680;
  chpl____wide__ref__domain_DefaultRectangularDom_1_int64_t_F chpl_macro_tmp_681;
  chpl____wide__ref__domain_DefaultRectangularDom_1_int64_t_F chpl_macro_tmp_682;
  chpl____wide__ref__domain_DefaultRectangularDom_1_int64_t_F chpl_macro_tmp_683;
  chpl____wide__nilType chpl_macro_tmp_684;
  chpl____wide_locale chpl_macro_tmp_685;
  ...
  chpl_macro_tmp_679.addr = nil;
  chpl_macro_tmp_680.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_680.addr = NULL;
  T2 = chpl_macro_tmp_680;
  ...
  chpl_macro_tmp_681.addr = _ref_tmp_2;
  T4 = chpl_macro_tmp_681;
  chpl_macro_tmp_682.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_682.addr = &ret_tmp3;
  T5 = chpl_macro_tmp_682;
  ...
  chpl_macro_tmp_683.addr = _ref_tmp_3;
  T6 = chpl_macro_tmp_683;
  ...
  chpl_macro_tmp_684.addr = nil;
  chpl_macro_tmp_685.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_685.addr = NULL;
  T8 = chpl_macro_tmp_685;
  (((locale)(wrap_call_tmp2)))->parent = T8;
  (((locale)(wrap_call_tmp2)))->nPUsPhysAcc = INT64(0);
  (((locale)(wrap_call_tmp2)))->nPUsPhysAll = INT64(0);
  (((locale)(wrap_call_tmp2)))->nPUsLogAcc = INT64(0);
  (((locale)(wrap_call_tmp2)))->nPUsLogAll = INT64(0);
  coerce_tmp = ((locale)(wrap_call_tmp2));
  (coerce_tmp)->maxTaskPar = INT64(0);
...
static int64_t getChildCount4(chpl____wide_RootLocale this12) {
  ...
  int64_t call_tmp3;
  chpl____wide__ref__domain_DefaultRectangularDom_1_int64_t_F chpl_macro_tmp_686;
  chpl_macro_tmp_686.locale = (&this12)->locale;
  chpl_macro_tmp_686.addr = &(((&this12)->addr)->myLocaleSpace);
  call_tmp2 = chpl_macro_tmp_686;
...
static chpl____wide_locale getChild4(chpl____wide_RootLocale this12,
  ...
  chpl____wide__ref__wide__array_DefaultRectangularArr_locale_1_int64_t_F_int64_t chpl_macro_tmp_687;
  chpl____wide__ref__wide_DefaultRectangularArr_locale_1_int64_t_F_int64_t chpl_macro_tmp_688;
  chpl____wide__ref__wide__ddata_locale chpl_macro_tmp_689;
  chpl____wide__ref__wide_locale chpl_macro_tmp_690;
  chpl_macro_tmp_687.locale = (&this12)->locale;
  chpl_macro_tmp_687.addr = &(((&this12)->addr)->myLocales);
  call_tmp2 = chpl_macro_tmp_687;
  chpl_macro_tmp_688.locale = (call_tmp2).locale;
  chpl_macro_tmp_688.addr = &(((call_tmp2).addr)->_instance);
  chpl_gen_comm_get(((void*)(&ret)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_688).locale), INT64(0), INT32(0)), (chpl_macro_tmp_688).addr, sizeof(chpl____wide_DefaultRectangularArr_locale_1_int64_t_F_int64_t), -1, COMMID(1), INT64(204), INT64(24));
  call_tmp3 = ret;
  chpl_macro_tmp_689.locale = (&call_tmp3)->locale;
  chpl_macro_tmp_689.addr = &(((&call_tmp3)->addr)->shiftedData);
  chpl_gen_comm_get(((void*)(&coerce_tmp)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_689).locale), INT64(0), INT32(0)), (chpl_macro_tmp_689).addr, sizeof(chpl____wide__ddata_locale), -1, COMMID(2), INT64(204), INT64(24));
  chpl_macro_tmp_690.locale = (&coerce_tmp)->locale;
  chpl_macro_tmp_690.addr = ((&coerce_tmp)->addr + idx);
  call_tmp4 = chpl_macro_tmp_690;
...
static chpl____wide_locale localeIDtoLocale2(chpl____wide_RootLocale this12,
  ...
  chpl____wide__ref_chpl_localeID_t chpl_macro_tmp_692;
  chpl____wide__ref__wide__array_DefaultRectangularArr_locale_1_int64_t_F_int64_t chpl_macro_tmp_693;
  chpl____wide__ref__wide_DefaultRectangularArr_locale_1_int64_t_F_int64_t chpl_macro_tmp_694;
  chpl____wide__ref__wide__ddata_locale chpl_macro_tmp_695;
  chpl____wide__ref__wide_locale chpl_macro_tmp_696;
  T = (&id2)->addr;
  call_tmp2 = chpl_rt_nodeFromLocaleID(*(T));
  chpl_macro_tmp_692.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_692.addr = T;
  id2 = chpl_macro_tmp_692;
  chpl_macro_tmp_693.locale = (&this12)->locale;
  chpl_macro_tmp_693.addr = &(((&this12)->addr)->myLocales);
  call_tmp3 = chpl_macro_tmp_693;
  call_tmp4 = ((int64_t)(call_tmp2));
  chpl_macro_tmp_694.locale = (call_tmp3).locale;
  chpl_macro_tmp_694.addr = &(((call_tmp3).addr)->_instance);
  chpl_gen_comm_get(((void*)(&ret)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_694).locale), INT64(0), INT32(0)), (chpl_macro_tmp_694).addr, sizeof(chpl____wide_DefaultRectangularArr_locale_1_int64_t_F_int64_t), -1, COMMID(4), INT64(219), INT64(24));
  call_tmp5 = ret;
  chpl_macro_tmp_695.locale = (&call_tmp5)->locale;
  chpl_macro_tmp_695.addr = &(((&call_tmp5)->addr)->shiftedData);
  chpl_gen_comm_get(((void*)(&coerce_tmp)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_695).locale), INT64(0), INT32(0)), (chpl_macro_tmp_695).addr, sizeof(chpl____wide__ddata_locale), -1, COMMID(5), INT64(219), INT64(24));
  chpl_macro_tmp_696.locale = (&coerce_tmp)->locale;
  chpl_macro_tmp_696.addr = ((&coerce_tmp)->addr + call_tmp4);
  call_tmp6 = chpl_macro_tmp_696;
...
static void deinit43(chpl____wide_RootLocale this12) {
  ...
  chpl____wide__ref__wide__array_DefaultRectangularArr_locale_1_int64_t_F_int64_t chpl_macro_tmp_697;
  chpl____wide__ref__wide_DefaultRectangularArr_locale_1_int64_t_F_int64_t chpl_macro_tmp_698;
  chpl____wide__ref__wide_DefaultRectangularDom_1_int64_t_F chpl_macro_tmp_699;
  chpl____wide__ref__wide__ddata_locale chpl_macro_tmp_700;
  chpl____wide__ref__wide_locale chpl_macro_tmp_701;
  chpl____wide__ref_int32_t chpl_macro_tmp_702;
  int32_t chpl_macro_tmp_703;
  chpl__class_localson_fn110_object chpl_macro_tmp_704;
  chpl____wide__ref__wide__array_DefaultRectangularArr_locale_1_int64_t_F_int64_t chpl_macro_tmp_705;
  chpl____wide__ref__domain_DefaultRectangularDom_1_int64_t_F chpl_macro_tmp_706;
  chpl____wide_AbstractRootLocale chpl_macro_tmp_707;
  chpl____wide_locale chpl_macro_tmp_708;
  chpl____wide__ref_atomic_int64 chpl_macro_tmp_709;
  chpl____wide__ref_atomic_int_least64_t chpl_macro_tmp_710;
  chpl____wide__ref_atomic_int_least64_t chpl_macro_tmp_711;
  chpl_macro_tmp_697.locale = (&this12)->locale;
  chpl_macro_tmp_697.addr = &(((&this12)->addr)->myLocales);
  call_tmp2 = chpl_macro_tmp_697;
  i_x = call_tmp2;
  chpl_macro_tmp_698.locale = (i_x).locale;
  chpl_macro_tmp_698.addr = &(((i_x).addr)->_instance);
  chpl_gen_comm_get(((void*)(&ret)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_698).locale), INT64(0), INT32(0)), (chpl_macro_tmp_698).addr, sizeof(chpl____wide_DefaultRectangularArr_locale_1_int64_t_F_int64_t), -1, COMMID(7), INT64(223), INT64(24));
  this13 = ret;
  chpl_macro_tmp_699.locale = (&this13)->locale;
  chpl_macro_tmp_699.addr = &(((&this13)->addr)->dom);
  chpl_gen_comm_get(((void*)(&coerce_tmp)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_699).locale), INT64(0), INT32(0)), (chpl_macro_tmp_699).addr, sizeof(chpl____wide_DefaultRectangularDom_1_int64_t_F), -1, COMMID(8), INT64(223), INT64(24));
  ...
  chpl_macro_tmp_700.locale = (&info)->locale;
  chpl_macro_tmp_700.addr = &(((&info)->addr)->shiftedData);
  chpl_gen_comm_get(((void*)(&coerce_tmp2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_700).locale), INT64(0), INT32(0)), (chpl_macro_tmp_700).addr, sizeof(chpl____wide__ddata_locale), -1, COMMID(9), INT64(223), INT64(24));
  for (i = call_tmp3; ((i <= _ic__F1_high)); i += _ic__F2_stride) {
    chpl_macro_tmp_701.locale = (&coerce_tmp2)->locale;
    chpl_macro_tmp_701.addr = ((&coerce_tmp2)->addr + i);
    call_tmp7 = chpl_macro_tmp_701;
    ...
    chpl_macro_tmp_702.locale = (&coerce_tmp3)->locale;
    chpl_macro_tmp_702.addr = &(((object)((&coerce_tmp3)->addr))->chpl__cid);
    chpl_gen_comm_get(((void*)(&chpl_macro_tmp_703)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_702).locale), INT64(0), INT32(0)), (chpl_macro_tmp_702).addr, sizeof(int32_t), -1, COMMID(11), INT64(224), INT64(24));
    ((void(*)(chpl____wide_locale))chpl_vmtable[((INT64(9) * chpl_macro_tmp_703) + INT64(0))])(coerce_tmp3);
    ...
    if (isdirect) {
      ...
      _args_foron_fn = ((_class_localson_fn110)(&chpl_macro_tmp_704));
  ...
  chpl_macro_tmp_705.addr = &(((&this12)->addr)->myLocales);
  chpl_gen_comm_get(((void*)(&T)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_705).locale), INT64(0), INT32(0)), (chpl_macro_tmp_705).addr, sizeof(_array_DefaultRectangularArr_locale_1_int64_t_F_int64_t), -1, COMMID(12), INT64(162), INT64(24));
  _field_destructor_tmp_ = T;
  chpl__autoDestroy27(&_field_destructor_tmp_);
  chpl_macro_tmp_706.locale = (&this12)->locale;
  chpl_macro_tmp_706.addr = &(((&this12)->addr)->myLocaleSpace);
  chpl_gen_comm_get(((void*)(&T2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_706).locale), INT64(0), INT32(0)), (chpl_macro_tmp_706).addr, sizeof(_domain_DefaultRectangularDom_1_int64_t_F), -1, COMMID(13), INT64(161), INT64(24));
  _field_destructor_tmp_2 = T2;
  chpl__autoDestroy5(&_field_destructor_tmp_2);
  chpl_macro_tmp_707.locale = (&this12)->locale;
  chpl_macro_tmp_707.addr = ((AbstractRootLocale)((&this12)->addr));
  _parent_destructor_tmp_ = chpl_macro_tmp_707;
  chpl_macro_tmp_708.locale = (&_parent_destructor_tmp_)->locale;
  chpl_macro_tmp_708.addr = ((locale)((&_parent_destructor_tmp_)->addr));
  _parent_destructor_tmp_2 = chpl_macro_tmp_708;
  chpl_macro_tmp_709.locale = (&_parent_destructor_tmp_2)->locale;
  chpl_macro_tmp_709.addr = &(((&_parent_destructor_tmp_2)->addr)->runningTaskCounter);
  _field_destructor_tmp_3 = chpl_macro_tmp_709;
  chpl_macro_tmp_710.locale = (_field_destructor_tmp_3).locale;
  chpl_macro_tmp_710.addr = &(((_field_destructor_tmp_3).addr)->_v);
  call_tmp9 = chpl_macro_tmp_710;
  T3 = (&call_tmp9)->addr;
  atomic_destroy_int_least64_t(T3);
  chpl_macro_tmp_711.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_711.addr = T3;
  call_tmp9 = chpl_macro_tmp_711;
  return;
}
