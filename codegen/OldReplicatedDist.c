...
static void chpl__auto_destroy_ReplicatedDist(chpl____wide_ReplicatedDist this_chpl6) {
  ...
  chpl____wide__ref__wide__array_DefaultAssociativeArr_locale_int64_t_T chpl_macro_tmp_7199;
  chpl____wide__ref__domain_DefaultAssociativeDom_int64_t_T chpl_macro_tmp_7200;
  chpl____wide_BaseDist chpl_macro_tmp_7201;
  chpl_macro_tmp_7199.locale = (&this_chpl6)->locale;
  chpl_macro_tmp_7199.addr = &(((&this_chpl6)->addr)->targetLocales_chpl);
  chpl_gen_comm_get(((void*)(&tmp_chpl)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_7199).locale), INT64(0), INT32(0)), (chpl_macro_tmp_7199).addr, sizeof(_array_DefaultAssociativeArr_locale_int64_t_T), -1, COMMID(0), INT64(180), INT64(61));
  _field_destructor_tmp__chpl = tmp_chpl;
  chpl__autoDestroy26(&_field_destructor_tmp__chpl);
  chpl_macro_tmp_7200.locale = (&this_chpl6)->locale;
  chpl_macro_tmp_7200.addr = &(((&this_chpl6)->addr)->targetLocDom_chpl);
  chpl_gen_comm_get(((void*)(&tmp_chpl2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_7200).locale), INT64(0), INT32(0)), (chpl_macro_tmp_7200).addr, sizeof(_domain_DefaultAssociativeDom_int64_t_T), -1, COMMID(1), INT64(177), INT64(61));
  _field_destructor_tmp__chpl2 = tmp_chpl2;
  chpl__autoDestroy8(&_field_destructor_tmp__chpl2);
  chpl_macro_tmp_7201.locale = (&this_chpl6)->locale;
  chpl_macro_tmp_7201.addr = ((BaseDist)((&this_chpl6)->addr));
  _parent_destructor_tmp__chpl = chpl_macro_tmp_7201;
