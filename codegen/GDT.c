...
static void chpl__auto_destroy_GDT(chpl____wide_GDT_FCHGlobalNode this_chpl6) {
  ...
  chpl____wide__ref__wide__array_CyclicArr_Bitmap_1_int64_t_F chpl_macro_tmp_5678;
  chpl____wide__ref__wide__array_CyclicArr__array_DefaultRectangularArr_FCHGlobalNode_1_int64_t_F_int64_t_1_int64_t_F chpl_macro_tmp_5679;
  chpl____wide__ref__domain_CyclicDom_1_int64_t_F chpl_macro_tmp_5680;
  chpl____wide__ref__domain_DefaultRectangularDom_1_int64_t_F chpl_macro_tmp_5681;
  chpl_macro_tmp_5678.locale = (&this_chpl6)->locale;
  chpl_macro_tmp_5678.addr = &(((&this_chpl6)->addr)->gdtBitmap_chpl);
  chpl_gen_comm_get(((void*)(&tmp_chpl)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_5678).locale), INT64(0), INT32(0)), (chpl_macro_tmp_5678).addr, sizeof(_array_CyclicArr_Bitmap_1_int64_t_F), -1, COMMID(0), INT64(22), INT64(56));
  ...
  chpl_macro_tmp_5679.addr = &(((&this_chpl6)->addr)->gdtEntries_chpl);
  chpl_gen_comm_get(((void*)(&tmp_chpl2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_5679).locale), INT64(0), INT32(0)), (chpl_macro_tmp_5679).addr, sizeof(_array_CyclicArr__array_DefaultRectangularArr_FCHGlobalNode_1_int64_t_F_int64_t_1_int64_t_F), -1, COMMID(1), INT64(21), INT64(56));
  _field_destructor_tmp__chpl2 = tmp_chpl2;
  chpl__autoDestroy30(&_field_destructor_tmp__chpl2);
  chpl_macro_tmp_5680.locale = (&this_chpl6)->locale;
  chpl_macro_tmp_5680.addr = &(((&this_chpl6)->addr)->locDom_chpl);
  chpl_gen_comm_get(((void*)(&tmp_chpl3)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_5680).locale), INT64(0), INT32(0)), (chpl_macro_tmp_5680).addr, sizeof(_domain_CyclicDom_1_int64_t_F), -1, COMMID(2), INT64(20), INT64(56));
  _field_destructor_tmp__chpl3 = tmp_chpl3;
  chpl__autoDestroy4(&_field_destructor_tmp__chpl3);
  chpl_macro_tmp_5681.locale = (&this_chpl6)->locale;
  chpl_macro_tmp_5681.addr = &(((&this_chpl6)->addr)->gdtSpace_chpl);
  chpl_gen_comm_get(((void*)(&tmp_chpl4)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_5681).locale), INT64(0), INT32(0)), (chpl_macro_tmp_5681).addr, sizeof(_domain_DefaultRectangularDom_1_int64_t_F), -1, COMMID(3), INT64(19), INT64(56));
...
static uint64_t register_chpl(GDT_FCHGlobalNode_chpl this_chpl6,
  ...
  chpl____wide__ref__wide_DefaultRectangularArr_FCHGlobalNode_1_int64_t_F_int64_t chpl_macro_tmp_5682;
  chpl____wide__ref__wide__ddata_FCHGlobalNode chpl_macro_tmp_5683;
  chpl____wide__ref__wide_FCHGlobalNode chpl_macro_tmp_5684;
  ...
  *(this_chpl7 + INT64(0)) = call_tmp_chpl3;
  coerce_tmp_chpl = (call_tmp_chpl4)->_pid;
  call_tmp_chpl5 = chpl_getPrivatizedCopy8(coerce_tmp_chpl);
  ...
  *(this_chpl8 + INT64(0)) = call_tmp_chpl11;
  coerce_tmp_chpl2 = (call_tmp_chpl12)->_pid;
  call_tmp_chpl13 = chpl_getPrivatizedCopy(coerce_tmp_chpl2);
  call_tmp_chpl14 = dsiAccess_chpl(call_tmp_chpl13, &this_chpl8);
  chpl_macro_tmp_5682.locale = (call_tmp_chpl14).locale;
  chpl_macro_tmp_5682.addr = &(((call_tmp_chpl14).addr)->_instance);
  chpl_gen_comm_get(((void*)(&ret_chpl)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_5682).locale), INT64(0), INT32(0)), (chpl_macro_tmp_5682).addr, sizeof(chpl____wide_DefaultRectangularArr_FCHGlobalNode_1_int64_t_F_int64_t), -1, COMMID(4), INT64(27), INT64(56));
  call_tmp_chpl15 = ret_chpl;
  chpl_macro_tmp_5683.locale = (&call_tmp_chpl15)->locale;
  chpl_macro_tmp_5683.addr = &(((&call_tmp_chpl15)->addr)->shiftedData);
  chpl_gen_comm_get(((void*)(&coerce_tmp_chpl3)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_5683).locale), INT64(0), INT32(0)), (chpl_macro_tmp_5683).addr, sizeof(chpl____wide__ddata_FCHGlobalNode), -1, COMMID(5), INT64(27), INT64(56));
  chpl_macro_tmp_5684.locale = (&coerce_tmp_chpl3)->locale;
  chpl_macro_tmp_5684.addr = ((&coerce_tmp_chpl3)->addr + call_tmp_chpl8);
  call_tmp_chpl16 = chpl_macro_tmp_5684;
