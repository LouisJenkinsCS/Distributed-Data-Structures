...
static void chpl__init_ChapelLocale(int64_t _ln,
  ...
  chpl____wide_locale chpl_macro_tmp_712;
  chpl____wide_locale chpl_macro_tmp_713;
  chpl____wide__ref__wide_locale chpl_macro_tmp_714;
  chpl____wide_DummyLocale chpl_macro_tmp_715;
  chpl____wide__ref__wide_DummyLocale chpl_macro_tmp_716;
  ...
  *(refIndentLevel) += INT64(1);
  ...
  T = nil;
  chpl_macro_tmp_712.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_712.addr = T;
  rootLocale = chpl_macro_tmp_712;
  T2 = nil;
  chpl_macro_tmp_713.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_713.addr = T2;
  T3 = chpl_macro_tmp_713;
  chpl_macro_tmp_714.locale = (&origRootLocale)->locale;
  chpl_macro_tmp_714.addr = &(((&origRootLocale)->addr)->value);
  chpl_gen_comm_put(((void*)(&T3)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_714).locale), INT64(0), INT32(0)), (chpl_macro_tmp_714).addr, sizeof(chpl____wide_locale), -1, COMMID(0), INT64(386), INT64(25));
  ...
  chpl_macro_tmp_715.addr = wrap_call_tmp;
  T4 = chpl_macro_tmp_715;
  chpl_macro_tmp_716.locale = (&dummyLocale)->locale;
  chpl_macro_tmp_716.addr = &(((&dummyLocale)->addr)->value);
  chpl_gen_comm_put(((void*)(&T4)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_716).locale), INT64(0), INT32(0)), (chpl_macro_tmp_716).addr, sizeof(chpl____wide_DummyLocale), -1, COMMID(1), INT64(563), INT64(25));
  *(refIndentLevel) -= INT64(1);
...
static locale _construct_locale(locale parent,
  ...
  chpl____wide_locale chpl_macro_tmp_717;
  this12 = meme;
  _construct_object(&((this12)->super));
  chpl_macro_tmp_717.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_717.addr = parent;
  T = chpl_macro_tmp_717;
  (this12)->parent = T;
...
static void chpl__auto_destroy_locale(chpl____wide_locale this12) {
  ...
  chpl____wide__ref_atomic_int64 chpl_macro_tmp_718;
  chpl____wide__ref_atomic_int_least64_t chpl_macro_tmp_719;
  chpl____wide__ref_atomic_int_least64_t chpl_macro_tmp_720;
  chpl_macro_tmp_718.locale = (&this12)->locale;
  chpl_macro_tmp_718.addr = &(((&this12)->addr)->runningTaskCounter);
  _field_destructor_tmp_ = chpl_macro_tmp_718;
  chpl_macro_tmp_719.locale = (_field_destructor_tmp_).locale;
  chpl_macro_tmp_719.addr = &(((_field_destructor_tmp_).addr)->_v);
  call_tmp2 = chpl_macro_tmp_719;
  T = (&call_tmp2)->addr;
  atomic_destroy_int_least64_t(T);
  chpl_macro_tmp_720.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_720.addr = T;
  call_tmp2 = chpl_macro_tmp_720;
  return;
}
...
static int64_t id(chpl____wide_locale this12) {
  ...
  chpl_macro_tmp_721.addr = &(((object)((&this12)->addr))->chpl__cid);
  chpl_gen_comm_get(((void*)(&chpl_macro_tmp_722)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_721).locale), INT64(0), INT32(0)), (chpl_macro_tmp_721).addr, sizeof(int32_t), -1, COMMID(2), INT64(177), INT64(25));
  call_tmp2 = ((int64_t(*)(chpl____wide_locale))chpl_vmtable[((INT64(9) * chpl_macro_tmp_722) + INT64(2))])(this12);
  return call_tmp2;
}
...
static void chpl__auto_destroy_DummyLocale(chpl____wide_DummyLocale this12) {
  ...
  chpl____wide__ref_atomic_int_least64_t call_tmp2 = {CHPL_LOCALEID_T_INIT, NULL};
  _ref_atomic_int_least64_t T = NULL;
  chpl____wide_locale chpl_macro_tmp_723;
  chpl____wide__ref_atomic_int64 chpl_macro_tmp_724;
  chpl____wide__ref_atomic_int_least64_t chpl_macro_tmp_725;
  chpl____wide__ref_atomic_int_least64_t chpl_macro_tmp_726;
  chpl_macro_tmp_723.locale = (&this12)->locale;
  chpl_macro_tmp_723.addr = ((locale)((&this12)->addr));
  _parent_destructor_tmp_ = chpl_macro_tmp_723;
  chpl_macro_tmp_724.locale = (&_parent_destructor_tmp_)->locale;
  chpl_macro_tmp_724.addr = &(((&_parent_destructor_tmp_)->addr)->runningTaskCounter);
  _field_destructor_tmp_ = chpl_macro_tmp_724;
  chpl_macro_tmp_725.locale = (_field_destructor_tmp_).locale;
  chpl_macro_tmp_725.addr = &(((_field_destructor_tmp_).addr)->_v);
  call_tmp2 = chpl_macro_tmp_725;
  T = (&call_tmp2)->addr;
  atomic_destroy_int_least64_t(T);
  chpl_macro_tmp_726.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_726.addr = T;
  call_tmp2 = chpl_macro_tmp_726;
  return;
}
...
static chpl____wide_locale getChild2(chpl____wide_DummyLocale this12,
  ...
  chpl____wide_locale chpl_macro_tmp_727;
  chpl_macro_tmp_727.locale = (&this12)->locale;
  chpl_macro_tmp_727.addr = ((locale)((&this12)->addr));
  call_tmp2 = chpl_macro_tmp_727;
  return call_tmp2;
}
...
static void chpl__auto_destroy_AbstractLocaleModel(chpl____wide_AbstractLocaleModel this12) {
  ...
  chpl____wide__ref_atomic_int_least64_t call_tmp2 = {CHPL_LOCALEID_T_INIT, NULL};
  _ref_atomic_int_least64_t T = NULL;
  chpl____wide_locale chpl_macro_tmp_728;
  chpl____wide__ref_atomic_int64 chpl_macro_tmp_729;
  chpl____wide__ref_atomic_int_least64_t chpl_macro_tmp_730;
  chpl____wide__ref_atomic_int_least64_t chpl_macro_tmp_731;
  chpl_macro_tmp_728.locale = (&this12)->locale;
  chpl_macro_tmp_728.addr = ((locale)((&this12)->addr));
  _parent_destructor_tmp_ = chpl_macro_tmp_728;
  chpl_macro_tmp_729.locale = (&_parent_destructor_tmp_)->locale;
  chpl_macro_tmp_729.addr = &(((&_parent_destructor_tmp_)->addr)->runningTaskCounter);
  _field_destructor_tmp_ = chpl_macro_tmp_729;
  chpl_macro_tmp_730.locale = (_field_destructor_tmp_).locale;
  chpl_macro_tmp_730.addr = &(((_field_destructor_tmp_).addr)->_v);
  call_tmp2 = chpl_macro_tmp_730;
  T = (&call_tmp2)->addr;
  atomic_destroy_int_least64_t(T);
  chpl_macro_tmp_731.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_731.addr = T;
  call_tmp2 = chpl_macro_tmp_731;
  return;
}
...
static void chpl__auto_destroy_AbstractRootLocale(chpl____wide_AbstractRootLocale this12) {
  ...
  chpl____wide__ref_atomic_int_least64_t call_tmp2 = {CHPL_LOCALEID_T_INIT, NULL};
  _ref_atomic_int_least64_t T = NULL;
  chpl____wide_locale chpl_macro_tmp_732;
  chpl____wide__ref_atomic_int64 chpl_macro_tmp_733;
  chpl____wide__ref_atomic_int_least64_t chpl_macro_tmp_734;
  chpl____wide__ref_atomic_int_least64_t chpl_macro_tmp_735;
  chpl_macro_tmp_732.locale = (&this12)->locale;
  chpl_macro_tmp_732.addr = ((locale)((&this12)->addr));
  _parent_destructor_tmp_ = chpl_macro_tmp_732;
  chpl_macro_tmp_733.locale = (&_parent_destructor_tmp_)->locale;
  chpl_macro_tmp_733.addr = &(((&_parent_destructor_tmp_)->addr)->runningTaskCounter);
  _field_destructor_tmp_ = chpl_macro_tmp_733;
  chpl_macro_tmp_734.locale = (_field_destructor_tmp_).locale;
  chpl_macro_tmp_734.addr = &(((_field_destructor_tmp_).addr)->_v);
  call_tmp2 = chpl_macro_tmp_734;
  T = (&call_tmp2)->addr;
  atomic_destroy_int_least64_t(T);
  chpl_macro_tmp_735.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_735.addr = T;
  call_tmp2 = chpl_macro_tmp_735;
  return;
}
...
static chpl____wide_locale localeIDtoLocale(chpl____wide_AbstractRootLocale this12,
  ...
  string local__str_literal_32;
  chpl____wide_locale call_tmp2 = {CHPL_LOCALEID_T_INIT, NULL};
  chpl____wide_locale chpl_macro_tmp_736;
  local__str_literal_32 /* "Pure virtual function called." */ = _str_literal_32 /* "Pure virtual function called." */;
  halt(&local__str_literal_32 /* "Pure virtual function called." */, INT64(405), INT32(25));
  chpl_macro_tmp_736.locale = (&this12)->locale;
  chpl_macro_tmp_736.addr = ((locale)((&this12)->addr));
...
static void chpl__auto_destroy_localesSignal(chpl____wide_localesSignal this12) {
  ...
  chpl____wide__ref_atomicbool chpl_macro_tmp_737;
  chpl____wide__ref_atomic_bool chpl_macro_tmp_738;
  chpl____wide__ref_atomic_bool chpl_macro_tmp_739;
  chpl_macro_tmp_737.locale = (&this12)->locale;
  chpl_macro_tmp_737.addr = &(((&this12)->addr)->s);
  _field_destructor_tmp_ = chpl_macro_tmp_737;
  chpl_macro_tmp_738.locale = (_field_destructor_tmp_).locale;
  chpl_macro_tmp_738.addr = &(((_field_destructor_tmp_).addr)->_v);
  call_tmp2 = chpl_macro_tmp_738;
  T = (&call_tmp2)->addr;
  atomic_destroy_bool(T);
  chpl_macro_tmp_739.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_739.addr = T;
  call_tmp2 = chpl_macro_tmp_739;
  return;
}
...
static void wait5(_ref_localesBarrier this12,
  ...
  chpl____wide__ref__wide_DefaultRectangularDom_1_int64_t_F chpl_macro_tmp_740;
  chpl____wide__ref__wide__ddata_localesSignal chpl_macro_tmp_741;
  chpl____wide__ref__wide_localesSignal chpl_macro_tmp_742;
  chpl____wide_object chpl_macro_tmp_743;
  chpl____wide__nilType chpl_macro_tmp_744;
  chpl____wide_object chpl_macro_tmp_745;
  chpl____wide__ref__wide_DefaultRectangularDom_1_int64_t_F chpl_macro_tmp_746;
  chpl____wide__ref__wide__ddata_localesSignal chpl_macro_tmp_747;
  chpl____wide__ref__wide_localesSignal chpl_macro_tmp_748;
  chpl____wide__ref_atomicbool chpl_macro_tmp_749;
  chpl____wide__ref_chpl_bool chpl_macro_tmp_750;
  chpl__class_localson_fn3_object chpl_macro_tmp_751;
  chpl____wide__ref_chpl_bool chpl_macro_tmp_752;
  chpl____wide__ref__wide__ddata_localesSignal chpl_macro_tmp_753;
  chpl____wide__ref__wide_localesSignal chpl_macro_tmp_754;
  chpl____wide_localesSignal chpl_macro_tmp_755;
  chpl____wide__ref_atomicbool chpl_macro_tmp_756;
  chpl__class_localson_fn5_object chpl_macro_tmp_757;
  chpl____wide__ref_atomicbool chpl_macro_tmp_758;
  chpl____wide_localesSignal chpl_macro_tmp_759;
  chpl__class_localson_fn102_object chpl_macro_tmp_760;
  chpl____wide_localesSignal chpl_macro_tmp_761;
  ...
  if (call_tmp2) {
    ...
    while (T) {
      ...
      ret = (flags)->_instance;
      this13 = ret;
      chpl_macro_tmp_740.locale = (&this13)->locale;
      chpl_macro_tmp_740.addr = &(((&this13)->addr)->dom);
      chpl_gen_comm_get(((void*)(&coerce_tmp)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_740).locale), INT64(0), INT32(0)), (chpl_macro_tmp_740).addr, sizeof(chpl____wide_DefaultRectangularDom_1_int64_t_F), -1, COMMID(3), INT64(478), INT64(25));
      ...
      chpl_macro_tmp_741.locale = (&info)->locale;
      chpl_macro_tmp_741.addr = &(((&info)->addr)->shiftedData);
      chpl_gen_comm_get(((void*)(&coerce_tmp2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_741).locale), INT64(0), INT32(0)), (chpl_macro_tmp_741).addr, sizeof(chpl____wide__ddata_localesSignal), -1, COMMID(4), INT64(478), INT64(25));
      for (i = call_tmp3; ((i <= _ic__F1_high)); i += _ic__F2_stride) {
        chpl_macro_tmp_742.locale = (&coerce_tmp2)->locale;
        chpl_macro_tmp_742.addr = ((&coerce_tmp2)->addr + i);
        call_tmp7 = chpl_macro_tmp_742;
        ...
        chpl_macro_tmp_743.locale = (&coerce_tmp3)->locale;
        chpl_macro_tmp_743.addr = ((object)((&coerce_tmp3)->addr));
        call_tmp8 = chpl_macro_tmp_743;
        chpl_macro_tmp_744.locale = chpl_gen_getLocaleID();
        chpl_macro_tmp_744.addr = nil;
        chpl_macro_tmp_745.locale = chpl_gen_getLocaleID();
        chpl_macro_tmp_745.addr = NULL;
        T2 = chpl_macro_tmp_745;
    ...
    this14 = ret2;
    chpl_macro_tmp_746.locale = (&this14)->locale;
    chpl_macro_tmp_746.addr = &(((&this14)->addr)->dom);
    chpl_gen_comm_get(((void*)(&coerce_tmp4)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_746).locale), INT64(0), INT32(0)), (chpl_macro_tmp_746).addr, sizeof(chpl____wide_DefaultRectangularDom_1_int64_t_F), -1, COMMID(6), INT64(486), INT64(25));
    ...
    for (i2 = call_tmp12; ((i2 <= _ic__F1_high2)); i2 += _ic__F2_stride2) {
      chpl_macro_tmp_747.locale = (&info2)->locale;
      chpl_macro_tmp_747.addr = &(((&info2)->addr)->shiftedData);
      chpl_gen_comm_get(((void*)(&coerce_tmp5)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_747).locale), INT64(0), INT32(0)), (chpl_macro_tmp_747).addr, sizeof(chpl____wide__ddata_localesSignal), -1, COMMID(7), INT64(486), INT64(25));
      chpl_macro_tmp_748.locale = (&coerce_tmp5)->locale;
      chpl_macro_tmp_748.addr = ((&coerce_tmp5)->addr + i2);
      call_tmp16 = chpl_macro_tmp_748;
      ...
      chpl_macro_tmp_749.locale = (&coerce_tmp6)->locale;
      chpl_macro_tmp_749.addr = &(((&coerce_tmp6)->addr)->s);
      call_tmp17 = chpl_macro_tmp_749;
      ...
      if (isdirect) {
        ...
        chpl_macro_tmp_750.addr = T4;
        T5 = chpl_macro_tmp_750;
        on_fn3(T3, default_argorder2, T5);
      } else {
        _args_foron_fn = ((_class_localson_fn3)(&chpl_macro_tmp_751));
        ...
        chpl_macro_tmp_752.addr = T7;
        T8 = chpl_macro_tmp_752;
    ...
    call_tmp19 = ret5;
    chpl_macro_tmp_753.locale = (&call_tmp19)->locale;
    chpl_macro_tmp_753.addr = &(((&call_tmp19)->addr)->shiftedData);
    chpl_gen_comm_get(((void*)(&coerce_tmp7)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_753).locale), INT64(0), INT32(0)), (chpl_macro_tmp_753).addr, sizeof(chpl____wide__ddata_localesSignal), -1, COMMID(9), INT64(491), INT64(25));
    chpl_macro_tmp_754.locale = (&coerce_tmp7)->locale;
    chpl_macro_tmp_754.addr = ((&coerce_tmp7)->addr + locIdx);
    call_tmp20 = chpl_macro_tmp_754;
    chpl_macro_tmp_755.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_755.addr = wrap_call_tmp;
    T9 = chpl_macro_tmp_755;
    ...
    if (isdirect2) {
      ...
      chpl_macro_tmp_756.addr = T10;
      T11 = chpl_macro_tmp_756;
      on_fn5(T11, UINT8(true), default_argorder3);
    } else {
      _args_foron_fn2 = ((_class_localson_fn5)(&chpl_macro_tmp_757));
      (_args_foron_fn2)->_0_rvfDerefTmp = call_tmp22;
      T12 = call_tmp21;
      chpl_macro_tmp_758.locale = chpl_gen_getLocaleID();
      chpl_macro_tmp_758.addr = T12;
      T13 = chpl_macro_tmp_758;
    ...
    if (isdirect3) {
      ...
      T14 = chpl_macro_tmp_759;
      on_fn112(T14);
    } else {
      _args_foron_fn3 = ((_class_localson_fn102)(&chpl_macro_tmp_760));
      (_args_foron_fn3)->_0_rvfDerefTmp = call_tmp24;
      chpl_macro_tmp_761.locale = chpl_gen_getLocaleID();
      chpl_macro_tmp_761.addr = rvfDerefTmp;
      T15 = chpl_macro_tmp_761;
...
static void chpl_init_rootLocale(void) {
  ...
  chpl____wide_locale chpl_macro_tmp_762;
  chpl____wide__ref__wide_locale chpl_macro_tmp_763;
  chpl____wide__ref__wide_locale chpl_macro_tmp_764;
  chpl____wide_object chpl_macro_tmp_765;
  chpl____wide__nilType chpl_macro_tmp_766;
  chpl____wide_object chpl_macro_tmp_767;
  chpl____wide__ref_int32_t chpl_macro_tmp_768;
  int32_t chpl_macro_tmp_769;
  int32_t chpl_macro_tmp_770;
  chpl____wide_RootLocale chpl_macro_tmp_771;
  chpl____wide_RootLocale chpl_macro_tmp_772;
  call_tmp2 = RootLocale2();
  call_tmp3 = ((locale)(call_tmp2));
  chpl_macro_tmp_762.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_762.addr = call_tmp3;
  T = chpl_macro_tmp_762;
  chpl_macro_tmp_763.locale = (&origRootLocale)->locale;
  chpl_macro_tmp_763.addr = &(((&origRootLocale)->addr)->value);
  chpl_gen_comm_put(((void*)(&T)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_763).locale), INT64(0), INT32(0)), (chpl_macro_tmp_763).addr, sizeof(chpl____wide_locale), -1, COMMID(11), INT64(510), INT64(25));
  chpl_macro_tmp_764.locale = (&origRootLocale)->locale;
  chpl_macro_tmp_764.addr = &(((&origRootLocale)->addr)->value);
  chpl_gen_comm_get(((void*)(&T2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_764).locale), INT64(0), INT32(0)), (chpl_macro_tmp_764).addr, sizeof(chpl____wide_locale), -1, COMMID(12), INT64(386), INT64(25));
  chpl_macro_tmp_765.locale = (&T2)->locale;
  chpl_macro_tmp_765.addr = ((object)((&T2)->addr));
  call_tmp4 = chpl_macro_tmp_765;
  ...
  if (call_tmp5) {
    chpl_macro_tmp_768.locale = (T2).locale;
    chpl_macro_tmp_768.addr = &(((object)((T2).addr))->chpl__cid);
    chpl_gen_comm_get(((void*)(&chpl_macro_tmp_769)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_768).locale), INT64(0), INT32(0)), (chpl_macro_tmp_768).addr, sizeof(int32_t), -1, COMMID(13), INT64(511), INT64(25));
    chpl_macro_tmp_770 = chpl_macro_tmp_769;
    chpl_macro_tmp_771.locale = (T2).locale;
    chpl_macro_tmp_771.addr = ( (((chpl__cid_RootLocale <= chpl_macro_tmp_770) && (chpl_macro_tmp_770 <= chpl_subclass_max_id[chpl__cid_RootLocale])))?(((RootLocale)((T2).addr))):(((RootLocale)(NULL))) );
    call_tmp6 = chpl_macro_tmp_771;
    ret = call_tmp6;
    goto _end__if_fn18;
  } else {
    call_tmp7 = ((RootLocale)(nil));
    chpl_macro_tmp_772.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_772.addr = call_tmp7;
    ret = chpl_macro_tmp_772;
    goto _end__if_fn18;
  }
  _end__if_fn18:;
  setup2(ret);
...
static void chpl_rootLocaleInitPrivate(int64_t locIdx) {
  ...
  chpl____wide__ref__wide_locale chpl_macro_tmp_773;
  chpl____wide__ref__wide_locale chpl_macro_tmp_774;
  chpl____wide_object chpl_macro_tmp_775;
  chpl____wide__nilType chpl_macro_tmp_776;
  chpl____wide_object chpl_macro_tmp_777;
  chpl____wide__ref_int32_t chpl_macro_tmp_778;
  int32_t chpl_macro_tmp_779;
  int32_t chpl_macro_tmp_780;
  chpl____wide_RootLocale chpl_macro_tmp_781;
  chpl____wide_RootLocale chpl_macro_tmp_782;
  chpl____wide_RootLocale chpl_macro_tmp_783;
  chpl____wide__ref__wide_DefaultRectangularArr_locale_1_int64_t_F_int64_t chpl_macro_tmp_784;
  chpl____wide__ref__wide__ddata_locale chpl_macro_tmp_785;
  chpl____wide_RootLocale chpl_macro_tmp_786;
  chpl____wide__ref__wide_DefaultRectangularArr_locale_1_int64_t_F_int64_t chpl_macro_tmp_787;
  chpl____wide__ref__wide__ddata_locale chpl_macro_tmp_788;
  chpl____wide__ref__wide_locale chpl_macro_tmp_789;
  chpl____wide__ref__wide_locale chpl_macro_tmp_790;
  chpl____wide_locale chpl_macro_tmp_791;
  chpl____wide_object chpl_macro_tmp_792;
  chpl____wide__nilType chpl_macro_tmp_793;
  chpl____wide_object chpl_macro_tmp_794;
  chpl____wide__ref_int32_t chpl_macro_tmp_795;
  int32_t chpl_macro_tmp_796;
  int32_t chpl_macro_tmp_797;
  chpl____wide_RootLocale chpl_macro_tmp_798;
  chpl____wide_RootLocale chpl_macro_tmp_799;
  local_numLocales = numLocales;
  chpl_macro_tmp_773.locale = (&origRootLocale)->locale;
  chpl_macro_tmp_773.addr = &(((&origRootLocale)->addr)->value);
  chpl_gen_comm_get(((void*)(&T)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_773).locale), INT64(0), INT32(0)), (chpl_macro_tmp_773).addr, sizeof(chpl____wide_locale), -1, COMMID(14), INT64(386), INT64(25));
  rootLocale = T;
  call_tmp2 = (locIdx != INT64(0));
  if (call_tmp2) {
    newRootLocale = RootLocale2();
    chpl_macro_tmp_774.locale = (&origRootLocale)->locale;
    chpl_macro_tmp_774.addr = &(((&origRootLocale)->addr)->value);
    chpl_gen_comm_get(((void*)(&T2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_774).locale), INT64(0), INT32(0)), (chpl_macro_tmp_774).addr, sizeof(chpl____wide_locale), -1, COMMID(15), INT64(386), INT64(25));
    chpl_macro_tmp_775.locale = (&T2)->locale;
    chpl_macro_tmp_775.addr = ((object)((&T2)->addr));
    call_tmp3 = chpl_macro_tmp_775;
    chpl_macro_tmp_776.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_776.addr = nil;
    chpl_macro_tmp_777.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_777.addr = NULL;
    T3 = chpl_macro_tmp_777;
    ...
    if (call_tmp4) {
      chpl_macro_tmp_778.locale = (T2).locale;
      chpl_macro_tmp_778.addr = &(((object)((T2).addr))->chpl__cid);
      chpl_gen_comm_get(((void*)(&chpl_macro_tmp_779)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_778).locale), INT64(0), INT32(0)), (chpl_macro_tmp_778).addr, sizeof(int32_t), -1, COMMID(16), INT64(531), INT64(25));
      chpl_macro_tmp_780 = chpl_macro_tmp_779;
      chpl_macro_tmp_781.locale = (T2).locale;
      chpl_macro_tmp_781.addr = ( (((chpl__cid_RootLocale <= chpl_macro_tmp_780) && (chpl_macro_tmp_780 <= chpl_subclass_max_id[chpl__cid_RootLocale])))?(((RootLocale)((T2).addr))):(((RootLocale)(NULL))) );
      call_tmp5 = chpl_macro_tmp_781;
      ret = call_tmp5;
      goto _end__if_fn18;
    } else {
      call_tmp6 = ((RootLocale)(nil));
      chpl_macro_tmp_782.locale = chpl_gen_getLocaleID();
      chpl_macro_tmp_782.addr = call_tmp6;
      ret = chpl_macro_tmp_782;
      goto _end__if_fn18;
    }
    _end__if_fn18:;
    call_tmp7 = getDefaultLocaleArray(ret);
    chpl_macro_tmp_783.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_783.addr = newRootLocale;
    T4 = chpl_macro_tmp_783;
    getDefaultLocaleArray(T4);
    assert_chpl(UINT8(true));
    chpl_macro_tmp_784.locale = (call_tmp7).locale;
    chpl_macro_tmp_784.addr = &(((call_tmp7).addr)->_instance);
    chpl_gen_comm_get(((void*)(&ret2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_784).locale), INT64(0), INT32(0)), (chpl_macro_tmp_784).addr, sizeof(chpl____wide_DefaultRectangularArr_locale_1_int64_t_F_int64_t), -1, COMMID(17), INT64(534), INT64(25));
    call_tmp8 = ret2;
    chpl_macro_tmp_785.locale = (&call_tmp8)->locale;
    chpl_macro_tmp_785.addr = &(((&call_tmp8)->addr)->shiftedData);
    chpl_gen_comm_get(((void*)(&coerce_tmp)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_785).locale), INT64(0), INT32(0)), (chpl_macro_tmp_785).addr, sizeof(chpl____wide__ddata_locale), -1, COMMID(18), INT64(534), INT64(25));
    origRL = coerce_tmp;
    chpl_macro_tmp_786.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_786.addr = newRootLocale;
    T5 = chpl_macro_tmp_786;
    call_tmp9 = getDefaultLocaleArray(T5);
    chpl_macro_tmp_787.locale = (call_tmp9).locale;
    chpl_macro_tmp_787.addr = &(((call_tmp9).addr)->_instance);
    chpl_gen_comm_get(((void*)(&ret3)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_787).locale), INT64(0), INT32(0)), (chpl_macro_tmp_787).addr, sizeof(chpl____wide_DefaultRectangularArr_locale_1_int64_t_F_int64_t), -1, COMMID(19), INT64(535), INT64(25));
    call_tmp10 = ret3;
    chpl_macro_tmp_788.locale = (&call_tmp10)->locale;
    chpl_macro_tmp_788.addr = &(((&call_tmp10)->addr)->shiftedData);
    chpl_gen_comm_get(((void*)(&coerce_tmp2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_788).locale), INT64(0), INT32(0)), (chpl_macro_tmp_788).addr, sizeof(chpl____wide__ddata_locale), -1, COMMID(20), INT64(535), INT64(25));
    newRL = coerce_tmp2;
    chpl_macro_tmp_789.locale = (&newRL)->locale;
    chpl_macro_tmp_789.addr = ((&newRL)->addr + INT64(0));
    call_tmp11 = chpl_macro_tmp_789;
    chpl_macro_tmp_790.locale = (&origRL)->locale;
    chpl_macro_tmp_790.addr = ((&origRL)->addr + INT64(0));
    call_tmp12 = chpl_macro_tmp_790;
    ...
    chpl_macro_tmp_791.addr = ((locale)(newRootLocale));
    rootLocale = chpl_macro_tmp_791;
  }
  call_tmp13 = (locIdx != INT64(0));
  if (call_tmp13) {
    chpl_macro_tmp_792.locale = (&rootLocale)->locale;
    chpl_macro_tmp_792.addr = ((object)((&rootLocale)->addr));
    call_tmp14 = chpl_macro_tmp_792;
    chpl_macro_tmp_793.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_793.addr = nil;
    chpl_macro_tmp_794.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_794.addr = NULL;
    T6 = chpl_macro_tmp_794;
    ...
    if (call_tmp15) {
      chpl_macro_tmp_795.locale = (rootLocale).locale;
      chpl_macro_tmp_795.addr = &(((object)((rootLocale).addr))->chpl__cid);
      chpl_gen_comm_get(((void*)(&chpl_macro_tmp_796)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_795).locale), INT64(0), INT32(0)), (chpl_macro_tmp_795).addr, sizeof(int32_t), -1, COMMID(22), INT64(551), INT64(25));
      chpl_macro_tmp_797 = chpl_macro_tmp_796;
      chpl_macro_tmp_798.locale = (rootLocale).locale;
      chpl_macro_tmp_798.addr = ( (((chpl__cid_RootLocale <= chpl_macro_tmp_797) && (chpl_macro_tmp_797 <= chpl_subclass_max_id[chpl__cid_RootLocale])))?(((RootLocale)((rootLocale).addr))):(((RootLocale)(NULL))) );
      call_tmp16 = chpl_macro_tmp_798;
      ret4 = call_tmp16;
      goto _end__if_fn182;
    } else {
      call_tmp17 = ((RootLocale)(nil));
      chpl_macro_tmp_799.locale = chpl_gen_getLocaleID();
      chpl_macro_tmp_799.addr = call_tmp17;
      ret4 = chpl_macro_tmp_799;
      goto _end__if_fn182;
    }
    _end__if_fn182:;
...
static chpl____wide_locale chpl_localeID_to_locale(_ref_chpl_localeID_t id2) {
  ...
  chpl____wide__nilType chpl_macro_tmp_801;
  chpl____wide_object chpl_macro_tmp_802;
  chpl____wide_object chpl_macro_tmp_803;
  chpl____wide__nilType chpl_macro_tmp_804;
  chpl____wide_object chpl_macro_tmp_805;
  chpl____wide__ref_int32_t chpl_macro_tmp_806;
  int32_t chpl_macro_tmp_807;
  int32_t chpl_macro_tmp_808;
  chpl____wide_AbstractRootLocale chpl_macro_tmp_809;
  chpl____wide_AbstractRootLocale chpl_macro_tmp_810;
  chpl____wide__ref_chpl_localeID_t chpl_macro_tmp_811;
  chpl____wide__ref_int32_t chpl_macro_tmp_812;
  int32_t chpl_macro_tmp_813;
  chpl____wide__ref__wide_DummyLocale chpl_macro_tmp_814;
  chpl____wide_locale chpl_macro_tmp_815;
  local_dummyLocale = dummyLocale;
  chpl_macro_tmp_800.locale = (&rootLocale)->locale;
  chpl_macro_tmp_800.addr = ((object)((&rootLocale)->addr));
  call_tmp2 = chpl_macro_tmp_800;
  chpl_macro_tmp_801.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_801.addr = nil;
  chpl_macro_tmp_802.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_802.addr = NULL;
  T = chpl_macro_tmp_802;
  ...
  if (call_tmp3) {
    chpl_macro_tmp_803.locale = (&rootLocale)->locale;
    chpl_macro_tmp_803.addr = ((object)((&rootLocale)->addr));
    call_tmp4 = chpl_macro_tmp_803;
    chpl_macro_tmp_804.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_804.addr = nil;
    chpl_macro_tmp_805.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_805.addr = NULL;
    T2 = chpl_macro_tmp_805;
    ...
    if (call_tmp5) {
      chpl_macro_tmp_806.locale = (rootLocale).locale;
      chpl_macro_tmp_806.addr = &(((object)((rootLocale).addr))->chpl__cid);
      chpl_gen_comm_get(((void*)(&chpl_macro_tmp_807)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_806).locale), INT64(0), INT32(0)), (chpl_macro_tmp_806).addr, sizeof(int32_t), -1, COMMID(23), INT64(598), INT64(25));
      chpl_macro_tmp_808 = chpl_macro_tmp_807;
      chpl_macro_tmp_809.locale = (rootLocale).locale;
      chpl_macro_tmp_809.addr = ( (((chpl__cid_AbstractRootLocale <= chpl_macro_tmp_808) && (chpl_macro_tmp_808 <= chpl_subclass_max_id[chpl__cid_AbstractRootLocale])))?(((AbstractRootLocale)((rootLocale).addr))):(((AbstractRootLocale)(NULL))) );
      call_tmp6 = chpl_macro_tmp_809;
      ret2 = call_tmp6;
      goto _end__if_fn18;
    } else {
      call_tmp7 = ((AbstractRootLocale)(nil));
      chpl_macro_tmp_810.locale = chpl_gen_getLocaleID();
      chpl_macro_tmp_810.addr = call_tmp7;
      ret2 = chpl_macro_tmp_810;
      goto _end__if_fn18;
    }
    _end__if_fn18:;
    chpl_macro_tmp_811.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_811.addr = id2;
    T3 = chpl_macro_tmp_811;
    chpl_macro_tmp_812.locale = (&ret2)->locale;
    chpl_macro_tmp_812.addr = &(((object)((&ret2)->addr))->chpl__cid);
    chpl_gen_comm_get(((void*)(&chpl_macro_tmp_813)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_812).locale), INT64(0), INT32(0)), (chpl_macro_tmp_812).addr, sizeof(int32_t), -1, COMMID(24), INT64(598), INT64(25));
    call_tmp8 = ((chpl____wide_locale(*)(chpl____wide_AbstractRootLocale,
                   chpl____wide__ref_chpl_localeID_t))chpl_vmtable[((INT64(9) * chpl_macro_tmp_813) + INT64(4))])(ret2, T3);
    ret = call_tmp8;
    goto _end_chpl_localeID_to_locale;
  } else {
    chpl_macro_tmp_814.locale = (&local_dummyLocale)->locale;
    chpl_macro_tmp_814.addr = &(((&local_dummyLocale)->addr)->value);
    chpl_gen_comm_get(((void*)(&T4)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_814).locale), INT64(0), INT32(0)), (chpl_macro_tmp_814).addr, sizeof(chpl____wide_DummyLocale), -1, COMMID(25), INT64(563), INT64(25));
    chpl_macro_tmp_815.locale = (&T4)->locale;
    chpl_macro_tmp_815.addr = ((locale)((&T4)->addr));
    call_tmp9 = chpl_macro_tmp_815;
    ret = call_tmp9;
    goto _end_chpl_localeID_to_locale;
  }
...
static int64_t runningTasks(chpl____wide_locale this12) {
  ...
  int64_t ret2;
  chpl_bool call_tmp4;
  chpl____wide__ref_atomic_int64 chpl_macro_tmp_816;
  chpl____wide__ref_int64_t chpl_macro_tmp_817;
  chpl__class_localson_fn10_object chpl_macro_tmp_818;
  chpl____wide__ref_int64_t chpl_macro_tmp_819;
  local_memory_order_relaxed = memory_order_relaxed;
  chpl_macro_tmp_816.locale = (&this12)->locale;
  chpl_macro_tmp_816.addr = &(((&this12)->addr)->runningTaskCounter);
  call_tmp2 = chpl_macro_tmp_816;
  ret = INT64(0);
  ...
  if (isdirect) {
    ...
    chpl_macro_tmp_817.addr = T2;
    T3 = chpl_macro_tmp_817;
    on_fn10(T, rvfDerefTmp, T3);
  } else {
    _args_foron_fn = ((_class_localson_fn10)(&chpl_macro_tmp_818));
    ...
    chpl_macro_tmp_819.addr = T5;
    T6 = chpl_macro_tmp_819;
...
void chpl_taskRunningCntInc(int64_t _ln,
  ...
  chpl__class_localson_fn13_object chpl_macro_tmp_821;
  local_memory_order_relaxed = memory_order_relaxed;
  _autoCopy_tmp_ = chpl_rt_buildLocaleID(chpl_nodeID, c_sublocid_any);
  ...
  if (isdirect) {
    ...
    _args_foron_fn = ((_class_localson_fn13)(&chpl_macro_tmp_821));
...
void chpl_taskRunningCntDec(int64_t _ln,
  ...
  chpl____wide__ref_atomic_int64 T2 = {CHPL_LOCALEID_T_INIT, NULL};
  c_void_ptr _args_vforon_fn;
  chpl____wide__ref_atomic_int64 chpl_macro_tmp_822;
  chpl__class_localson_fn14_object chpl_macro_tmp_823;
  local_memory_order_relaxed = memory_order_relaxed;
  _autoCopy_tmp_ = chpl_rt_buildLocaleID(chpl_nodeID, c_sublocid_any);
  call_tmp3 = chpl_localeID_to_locale(&_autoCopy_tmp_);
  call_tmp2 = call_tmp3;
  chpl_macro_tmp_822.locale = (&call_tmp2)->locale;
  chpl_macro_tmp_822.addr = &(((&call_tmp2)->addr)->runningTaskCounter);
  call_tmp4 = chpl_macro_tmp_822;
  call_tmp5 = (&call_tmp4)->locale;
  T = call_tmp4;
  rvfDerefTmp = local_memory_order_relaxed;
  isdirect = chpl_doDirectExecuteOn(&call_tmp5);
  if (isdirect) {
    ...
    _args_foron_fn = ((_class_localson_fn14)(&chpl_macro_tmp_823));
    (_args_foron_fn)->_0_rvfDerefTmp = call_tmp5;
    T2 = call_tmp4;
    (_args_foron_fn)->_1_tmp = T2;
    (_args_foron_fn)->_2_rvfDerefTmp = INT64(1);
...
static void deinit40(void) {
  ...
  c_void_ptr _args_vforon_fn;
  chpl____wide__ref__wide_locale chpl_macro_tmp_824;
  chpl____wide__ref_int32_t chpl_macro_tmp_825;
  int32_t chpl_macro_tmp_826;
  chpl__class_localson_fn110_object chpl_macro_tmp_827;
  chpl_macro_tmp_824.locale = (&origRootLocale)->locale;
  chpl_macro_tmp_824.addr = &(((&origRootLocale)->addr)->value);
  chpl_gen_comm_get(((void*)(&T)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_824).locale), INT64(0), INT32(0)), (chpl_macro_tmp_824).addr, sizeof(chpl____wide_locale), -1, COMMID(26), INT64(386), INT64(25));
  chpl_macro_tmp_825.locale = (&T)->locale;
  chpl_macro_tmp_825.addr = &(((object)((&T)->addr))->chpl__cid);
  chpl_gen_comm_get(((void*)(&chpl_macro_tmp_826)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_825).locale), INT64(0), INT32(0)), (chpl_macro_tmp_825).addr, sizeof(int32_t), -1, COMMID(27), INT64(681), INT64(25));
  ((void(*)(chpl____wide_locale))chpl_vmtable[((INT64(9) * chpl_macro_tmp_826) + INT64(0))])(T);
  call_tmp2 = (&T)->locale;
  rvfDerefTmp = T;
  ...
  if (isdirect) {
    ...
    _args_foron_fn = ((_class_localson_fn110)(&chpl_macro_tmp_827));
