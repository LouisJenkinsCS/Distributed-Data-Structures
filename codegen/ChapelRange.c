...
static int64_t length2(chpl____wide__ref_range_int64_t_bounded_F this12) {
  ...
  int64_t T4;
  int64_t call_tmp3;
  chpl____wide__ref_int64_t chpl_macro_tmp_622;
  chpl____wide__ref_int64_t chpl_macro_tmp_623;
  chpl____wide__ref_int64_t chpl_macro_tmp_624;
  chpl____wide__ref_int64_t chpl_macro_tmp_625;
  chpl_macro_tmp_622.locale = (this12).locale;
  chpl_macro_tmp_622.addr = &(((this12).addr)->_low);
  chpl_gen_comm_get(((void*)(&T)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_622).locale), INT64(0), INT32(0)), (chpl_macro_tmp_622).addr, sizeof(int64_t), -1, COMMID(0), INT64(351), INT64(21));
  chpl_macro_tmp_623.locale = (this12).locale;
  chpl_macro_tmp_623.addr = &(((this12).addr)->_high);
  chpl_gen_comm_get(((void*)(&T2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_623).locale), INT64(0), INT32(0)), (chpl_macro_tmp_623).addr, sizeof(int64_t), -1, COMMID(1), INT64(351), INT64(21));
  call_tmp2 = (T > T2);
  if (call_tmp2) {
    ret = INT64(0);
    goto _end_length;
  ...
  chpl_macro_tmp_624.addr = &(((this12).addr)->_high);
  chpl_gen_comm_get(((void*)(&T3)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_624).locale), INT64(0), INT32(0)), (chpl_macro_tmp_624).addr, sizeof(int64_t), -1, COMMID(2), INT64(353), INT64(21));
  chpl_macro_tmp_625.locale = (this12).locale;
  chpl_macro_tmp_625.addr = &(((this12).addr)->_low);
  chpl_gen_comm_get(((void*)(&T4)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_625).locale), INT64(0), INT32(0)), (chpl_macro_tmp_625).addr, sizeof(int64_t), -1, COMMID(3), INT64(353), INT64(21));
...
static int64_t length(chpl____wide__ref_range_int64_t_bounded_T this12) {
  ...
  chpl_macro_tmp_626.addr = &(((this12).addr)->_low);
  chpl_gen_comm_get(((void*)(&T)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_626).locale), INT64(0), INT32(0)), (chpl_macro_tmp_626).addr, sizeof(int64_t), -1, COMMID(4), INT64(351), INT64(21));
  chpl_macro_tmp_627.locale = (this12).locale;
  chpl_macro_tmp_627.addr = &(((this12).addr)->_high);
  chpl_gen_comm_get(((void*)(&T2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_627).locale), INT64(0), INT32(0)), (chpl_macro_tmp_627).addr, sizeof(int64_t), -1, COMMID(5), INT64(351), INT64(21));
  call_tmp2 = (T > T2);
  if (call_tmp2) {
    ret = INT64(0);
    goto _end_length;
  ...
  chpl_macro_tmp_628.addr = &(((this12).addr)->_stride);
  chpl_gen_comm_get(((void*)(&T3)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_628).locale), INT64(0), INT32(0)), (chpl_macro_tmp_628).addr, sizeof(int64_t), -1, COMMID(6), INT64(352), INT64(21));
  ret2 = T3;
  ...
  chpl_macro_tmp_629.addr = &(((this12).addr)->_stride);
  chpl_gen_comm_get(((void*)(&T4)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_629).locale), INT64(0), INT32(0)), (chpl_macro_tmp_629).addr, sizeof(int64_t), -1, COMMID(7), INT64(353), INT64(21));
  chpl_macro_tmp_630.locale = (this12).locale;
  chpl_macro_tmp_630.addr = &(((this12).addr)->_high);
  chpl_gen_comm_get(((void*)(&T5)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_630).locale), INT64(0), INT32(0)), (chpl_macro_tmp_630).addr, sizeof(int64_t), -1, COMMID(8), INT64(353), INT64(21));
  chpl_macro_tmp_631.locale = (this12).locale;
  chpl_macro_tmp_631.addr = &(((this12).addr)->_alignment);
  chpl_gen_comm_get(((void*)(&T6)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_631).locale), INT64(0), INT32(0)), (chpl_macro_tmp_631).addr, sizeof(int64_t), -1, COMMID(9), INT64(353), INT64(21));
  call_tmp4 = chpl__diffMod(T5, T6, T4);
  chpl_macro_tmp_632.locale = (this12).locale;
  chpl_macro_tmp_632.addr = &(((this12).addr)->_high);
  chpl_gen_comm_get(((void*)(&T7)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_632).locale), INT64(0), INT32(0)), (chpl_macro_tmp_632).addr, sizeof(int64_t), -1, COMMID(10), INT64(353), INT64(21));
  call_tmp5 = (T7 - call_tmp4);
  chpl_macro_tmp_633.locale = (this12).locale;
  chpl_macro_tmp_633.addr = &(((this12).addr)->_stride);
  chpl_gen_comm_get(((void*)(&T8)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_633).locale), INT64(0), INT32(0)), (chpl_macro_tmp_633).addr, sizeof(int64_t), -1, COMMID(11), INT64(353), INT64(21));
  chpl_macro_tmp_634.locale = (this12).locale;
  chpl_macro_tmp_634.addr = &(((this12).addr)->_alignment);
  chpl_gen_comm_get(((void*)(&T9)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_634).locale), INT64(0), INT32(0)), (chpl_macro_tmp_634).addr, sizeof(int64_t), -1, COMMID(12), INT64(353), INT64(21));
  chpl_macro_tmp_635.locale = (this12).locale;
  chpl_macro_tmp_635.addr = &(((this12).addr)->_low);
  chpl_gen_comm_get(((void*)(&T10)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_635).locale), INT64(0), INT32(0)), (chpl_macro_tmp_635).addr, sizeof(int64_t), -1, COMMID(13), INT64(353), INT64(21));
  call_tmp6 = chpl__diffMod(T9, T10, T8);
  chpl_macro_tmp_636.locale = (this12).locale;
  chpl_macro_tmp_636.addr = &(((this12).addr)->_low);
  chpl_gen_comm_get(((void*)(&T11)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_636).locale), INT64(0), INT32(0)), (chpl_macro_tmp_636).addr, sizeof(int64_t), -1, COMMID(14), INT64(353), INT64(21));
...
static chpl_bool _local_isAmbiguous(chpl____wide__ref_range_int64_t_bounded_T this12) {
  ...
  ret2 = (local_this)->_aligned;
  call_tmp2 = (! ret2);
  if (call_tmp2) {
    local_this2 = (&this12)->addr;
    ret4 = (local_this2)->_stride;
...
static chpl_bool isAmbiguous(chpl____wide__ref_range_int64_t_bounded_T this12) {
  ...
  chpl_bool call_tmp3;
  int64_t T3;
  chpl____wide__ref_chpl_bool chpl_macro_tmp_637;
  chpl____wide__ref_int64_t chpl_macro_tmp_638;
  chpl____wide__ref_int64_t chpl_macro_tmp_639;
  chpl_macro_tmp_637.locale = (this12).locale;
  chpl_macro_tmp_637.addr = &(((this12).addr)->_aligned);
  chpl_gen_comm_get(((void*)(&T)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_637).locale), INT64(0), INT32(0)), (chpl_macro_tmp_637).addr, sizeof(chpl_bool), -1, COMMID(15), INT64(414), INT64(21));
  call_tmp2 = (! T);
  if (call_tmp2) {
    chpl_macro_tmp_638.locale = (this12).locale;
    chpl_macro_tmp_638.addr = &(((this12).addr)->_stride);
    chpl_gen_comm_get(((void*)(&T2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_638).locale), INT64(0), INT32(0)), (chpl_macro_tmp_638).addr, sizeof(int64_t), -1, COMMID(16), INT64(414), INT64(21));
    ...
    if (call_tmp3) {
      ...
      chpl_macro_tmp_639.addr = &(((this12).addr)->_stride);
      chpl_gen_comm_get(((void*)(&T3)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_639).locale), INT64(0), INT32(0)), (chpl_macro_tmp_639).addr, sizeof(int64_t), -1, COMMID(17), INT64(414), INT64(21));
      ret2 = (T3 < INT64(-1));
      goto _end__if_fn360;
    }
    _end__if_fn360:;
...
static void alignHigh(_ref_range_int64_t_bounded_T this12,
  ...
  int64_t coerce_tmp2;
  int64_t coerce_tmp3;
  chpl____wide__ref_range_int64_t_bounded_T chpl_macro_tmp_640;
  chpl_macro_tmp_640.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_640.addr = this12;
  T = chpl_macro_tmp_640;
...
static void this6(_ref_range_int64_t_bounded_F this12,
  ...
  int64_t call_tmp16;
  chpl____wide__ref_range_int64_t_bounded_T chpl_macro_tmp_641;
  ambig = UINT8(false);
  T = other;
  chpl_macro_tmp_641.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_641.addr = T;
  T2 = chpl_macro_tmp_641;
  ...
  range3(newlo, ret8, newStride, INT64(0), ret9, ret_to_arg_ref_tmp_3);
  result = ret_tmp3;
  call_tmp11 = ((this12)->_alignment % INT64(1));
  coerce_tmp7 = (other)->_alignment;
  call_tmp12 = (coerce_tmp7 % ret4);
...
static void this5(_ref_range_int64_t_bounded_T this12,
  ...
  chpl_macro_tmp_642.addr = T;
  T4 = chpl_macro_tmp_642;
  T3 = isAmbiguous(T4);
  if (T3) {
    ret = UINT8(true);
    goto _end__if_fn380;
    ...
    chpl_macro_tmp_643.addr = T2;
    T5 = chpl_macro_tmp_643;
  ...
  ret15 = (other)->_stride;
  call_tmp9 = (ret14 != ret15);
  if (call_tmp9) {
    ret16 = (this12)->_stride;
    ret17 = (other)->_stride;
    ret13 = (ret16 != (-ret17));
    goto _end__if_fn384;
  } else {
  ...
  if (ret13) {
    ...
    lcm = call_tmp11;
    ret19 = (this12)->_stride;
    call_tmp12 = (ret19 > INT64(0));
    if (call_tmp12) {
      ret18 = call_tmp11;
      goto _end__if_fn44;
    } else {
  ...
  _end__if_fn386:;
  ret_to_arg_ref_tmp_3 = &ret_tmp3;
  range3(newlo, ret21, newStride, INT64(0), ret22, ret_to_arg_ref_tmp_3);
  result = ret_tmp3;
  coerce_tmp7 = (this12)->_alignment;
  call_tmp16 = (coerce_tmp7 % ret7);
  coerce_tmp8 = (other)->_alignment;
  call_tmp17 = (coerce_tmp8 % ret9);
  call_tmp18 = (((int64_t)((((int64_t)((call_tmp17 - call_tmp16))) % g))) != INT64(0));
  if (call_tmp18) {
    (&result)->_low = INT64(1);
    (&result)->_high = INT64(0);
    ret25 = (this12)->_stride;
    call_tmp19 = (ret25 > INT64(0));
    if (call_tmp19) {
      ret24 = INT64(1);
      goto _end__if_fn45;
    } else {
...
static void chpl_count_help(_ref_range_int64_t_boundedLow_F r,
  ...
  _end__if_fn47:;
  coerce_tmp2 = (r)->_aligned;
  ret_to_arg_ref_tmp_2 = &ret_tmp2;
  range(ret3, ret4, INT64(1), (r)->_alignment, coerce_tmp2, ret_to_arg_ref_tmp_2);
  ret = ret_tmp2;
