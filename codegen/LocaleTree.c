...
static void chpl__init_LocaleTree(int64_t _ln,
  ...
  chpl____wide__nilType chpl_macro_tmp_4510;
...
static void _construct_chpl_localeTreeRecord(locale left,
  ...
  chpl____wide_locale T = {CHPL_LOCALEID_T_INIT, NULL};
  chpl____wide_locale T2 = {CHPL_LOCALEID_T_INIT, NULL};
  chpl____wide_locale chpl_macro_tmp_4514;
  chpl____wide_locale chpl_macro_tmp_4515;
  this12 = *(meme);
  chpl_macro_tmp_4514.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_4514.addr = left;
  T = chpl_macro_tmp_4514;
  (&this12)->left = T;
  chpl_macro_tmp_4515.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_4515.addr = right;
  T2 = chpl_macro_tmp_4515;
  (&this12)->right = T2;
  *(_retArg) = this12;
  return;
}
...
static void chpl_initLocaleTree(void) {
  ...
  chpl____wide__ref__tuple_1_star_range_int64_t_bounded_F chpl_macro_tmp_4516;
  chpl____wide__ref_range_int64_t_bounded_F chpl_macro_tmp_4517;
  chpl____wide_locale chpl_macro_tmp_4518;
  chpl____wide_locale chpl_macro_tmp_4519;
  ...
  chpl____wide__ref_int32_t chpl_macro_tmp_4524;
  int32_t chpl_macro_tmp_4525;
  chpl__class_localson_fn188_object chpl_macro_tmp_4526;
  ...
  this12 = ret;
  chpl_macro_tmp_4516.locale = (&this12)->locale;
  chpl_macro_tmp_4516.addr = &(((&this12)->addr)->ranges);
  _this_tmp_ = chpl_macro_tmp_4516;
  chpl_macro_tmp_4517.locale = (_this_tmp_).locale;
  chpl_macro_tmp_4517.addr = (*((_this_tmp_).addr) + INT64(0));
  call_tmp2 = chpl_macro_tmp_4517;
  i_x = call_tmp2;
  ...
  for (i = (&_ic__F0_this)->_low; ((i <= end)); i += INT64(1)) {
    T2 = nil;
    chpl_macro_tmp_4518.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_4518.addr = T2;
    left = chpl_macro_tmp_4518;
    T3 = nil;
    chpl_macro_tmp_4519.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_4519.addr = T3;
    right = chpl_macro_tmp_4519;
    ...
    if (call_tmp4) {
      ...
      chpl_gen_comm_get(((void*)(&chpl_macro_tmp_4521)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_4520).locale), INT64(0), INT32(0)), (chpl_macro_tmp_4520).addr, sizeof(int32_t), -1, COMMID(1), INT64(41), INT64(31));
      call_tmp5 = ((chpl____wide_locale(*)(chpl____wide_locale,
                     int64_t))chpl_vmtable[((INT64(9) * chpl_macro_tmp_4521) + INT64(1))])(rootLocale, call_tmp3);
      left = call_tmp5;
      _ref_tmp_ = &child;
      *(_ref_tmp_) += INT64(1);
      ...
      if (call_tmp6) {
        ...
        chpl_gen_comm_get(((void*)(&chpl_macro_tmp_4523)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_4522).locale), INT64(0), INT32(0)), (chpl_macro_tmp_4522).addr, sizeof(int32_t), -1, COMMID(2), INT64(44), INT64(31));
        call_tmp7 = ((chpl____wide_locale(*)(chpl____wide_locale,
                       int64_t))chpl_vmtable[((INT64(9) * chpl_macro_tmp_4523) + INT64(1))])(rootLocale, child);
        right = call_tmp7;
      }
    }
    chpl_macro_tmp_4524.locale = (&rootLocale)->locale;
    chpl_macro_tmp_4524.addr = &(((object)((&rootLocale)->addr))->chpl__cid);
    chpl_gen_comm_get(((void*)(&chpl_macro_tmp_4525)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_4524).locale), INT64(0), INT32(0)), (chpl_macro_tmp_4524).addr, sizeof(int32_t), -1, COMMID(3), INT64(46), INT64(31));
    call_tmp8 = ((chpl____wide_locale(*)(chpl____wide_locale,
                   int64_t))chpl_vmtable[((INT64(9) * chpl_macro_tmp_4525) + INT64(1))])(rootLocale, i);
    ...
    if (isdirect) {
      ...
      _args_foron_fn = ((_class_localson_fn188)(&chpl_macro_tmp_4526));
