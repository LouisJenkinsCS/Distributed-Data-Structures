...
static void on_fn(chpl____wide__ref_atomicbool this12,
  ...
  chpl____wide__ref_atomic_bool chpl_macro_tmp_560;
  chpl____wide__ref_atomic_bool chpl_macro_tmp_561;
  chpl_macro_tmp_560.locale = (this12).locale;
  chpl_macro_tmp_560.addr = &(((this12).addr)->_v);
  call_tmp2 = chpl_macro_tmp_560;
  T = (&call_tmp2)->addr;
  call_tmp3 = atomic_load_explicit_bool(T, order);
  chpl_macro_tmp_561.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_561.addr = T;
...
static void wrapon_fn2(_class_localson_fn2 c) {
  ...
  T = (c)->_3_rvfDerefTmp;
  _3_rvfDerefTmp = T;
  on_fn2(_1_tmp, _2_rvfDerefTmp, _3_rvfDerefTmp);
  return;
}
...
static void _local_on_fn(chpl____wide__ref_atomicbool this12,
  ...
  chpl_macro_tmp_564.addr = &((local_this)->_v);
...
static void on_fn3(chpl____wide__ref_atomicbool this12,
  ...
  chpl_macro_tmp_566.locale = (this12).locale;
  chpl_macro_tmp_566.addr = &(((this12).addr)->_v);
...
static void _local_on_fn2(chpl____wide__ref_atomicbool this12,
  ...
  chpl_macro_tmp_568.addr = &((local_this)->_v);
...
static void on_fn4(chpl____wide__ref_atomicbool this12,
  ...
  chpl_macro_tmp_570.locale = (this12).locale;
  chpl_macro_tmp_570.addr = &(((this12).addr)->_v);
...
static void on_fn6(chpl____wide__ref_atomic_uint64 this12,
  ...
  chpl____wide__ref_atomic_uint_least64_t chpl_macro_tmp_576;
  chpl____wide__ref_atomic_uint_least64_t chpl_macro_tmp_577;
  chpl_macro_tmp_576.locale = (this12).locale;
  chpl_macro_tmp_576.addr = &(((this12).addr)->_v);
  call_tmp2 = chpl_macro_tmp_576;
  T = (&call_tmp2)->addr;
  call_tmp3 = atomic_load_explicit_uint_least64_t(T, order);
  chpl_macro_tmp_577.locale = chpl_gen_getLocaleID();
  chpl_macro_tmp_577.addr = T;
  call_tmp2 = chpl_macro_tmp_577;
...
static void wrapon_fn7(_class_localson_fn7 c) {
  ...
  T = (c)->_3_rvfDerefTmp;
  _3_rvfDerefTmp = T;
  on_fn7(_1_tmp, (c)->_2_rvfDerefTmp, _3_rvfDerefTmp);
  return;
}
...
static void wrapon_fn8(_class_localson_fn8 c) {
  ...
  _3_rvfDerefTmp = T;
  _4_tmp = (c)->_4_tmp;
  on_fn8(_1_tmp, (c)->_2_rvfDerefTmp, _3_rvfDerefTmp, _4_tmp);
  return;
}
...
static void wrapon_fn9(_class_localson_fn9 c) {
  ...
  T = (c)->_5_rvfDerefTmp;
  _5_rvfDerefTmp = T;
  on_fn9(_1_tmp, _2_tmp, (c)->_3_rvfDerefTmp, (c)->_4_rvfDerefTmp, _5_rvfDerefTmp);
  return;
}
...
static void on_fn10(chpl____wide__ref_atomic_int64 this12,
  ...
  chpl____wide__ref_atomic_int_least64_t chpl_macro_tmp_584;
  chpl____wide__ref_atomic_int_least64_t chpl_macro_tmp_585;
...
static void wrapon_fn12(_class_localson_fn12 c) {
  ...
  _3_rvfDerefTmp = T;
  _4_tmp = (c)->_4_tmp;
  on_fn12(_1_tmp, _2_rvfDerefTmp, _3_rvfDerefTmp, _4_tmp);
  return;
}
...
static void wrapon_fn14(_class_localson_fn14 c) {
  ...
  T = (c)->_3_rvfDerefTmp;
  _3_rvfDerefTmp = T;
  on_fn14(_1_tmp, (c)->_2_rvfDerefTmp, _3_rvfDerefTmp);
  return;
}
...
static void wrapon_fn15(_class_localson_fn15 c) {
  ...
  T = (c)->_3_rvfDerefTmp;
  _3_rvfDerefTmp = T;
  on_fn15(_1_tmp, (c)->_2_rvfDerefTmp, _3_rvfDerefTmp);
  return;
}
