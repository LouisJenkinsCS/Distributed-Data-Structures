...
static void halt(_ref_string s,
  ...
  chpl____wide__ref_string chpl_macro_tmp_4494;
  chpl____wide__ref_string chpl_macro_tmp_4495;
  ...
  if (call_tmp3) {
    ...
    i_s = s;
    chpl_macro_tmp_4494.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_4494.addr = i_s;
    T = chpl_macro_tmp_4494;
    ...
    _ref_tmp_ = &type_tmp;
    i_rhs = s;
    chpl_macro_tmp_4495.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_4495.addr = _ref_tmp_;
    T2 = chpl_macro_tmp_4495;
    chpl_macro_tmp_4496.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_4496.addr = i_rhs;
    T3 = chpl_macro_tmp_4496;
...
static void halt3(_ref_string _e1_args,
  ...
  chpl___PLUS_(&local__str_literal_1675 /* "halt reached - " */, &ret_tmp, ret_to_arg_ref_tmp_2);
  tmpstring = ret_tmp2;
  call_tmp3 = ((&tmpstring)->locale_id != chpl_nodeID);
  if (call_tmp3) {
    halt(&local__str_literal_337 /* "Cannot call .c_str() on a remote string" */, _ln, _fn);
  }
...
static void halt2(_ref_string _e1_args,
  ...
  coerce_tmp = (&tmpstring)->buff;
  chpl_error(((c_string)(((c_void_ptr)(coerce_tmp)))), _ln, _fn);
  _ref_tmp_ = &call_tmp2;
