...
static void chpl___ASSIGN_20(_ref_LocalAtomicObject_FCHLocalNode_FCHQueue_int64_t_uint64_t _arg1_chpl,
  ...
  chpl____wide__ref_atomic_uint64 chpl_macro_tmp_5493;
  chpl____wide__ref_uint64_t chpl_macro_tmp_5494;
  chpl__class_localson_fn6_object chpl_macro_tmp_5495;
  chpl____wide__ref_uint64_t chpl_macro_tmp_5496;
  chpl____wide__ref_atomic_uint64 chpl_macro_tmp_5497;
  chpl__class_localson_fn7_object chpl_macro_tmp_5498;
  chpl____wide__ref_atomic_uint64 chpl_macro_tmp_5499;
  local_memory_order_seq_cst_chpl = memory_order_seq_cst;
  call_tmp_chpl = &((_arg1_chpl)->_atomicVar_chpl);
  chpl_macro_tmp_5493.locale = (_arg2_chpl).locale;
  chpl_macro_tmp_5493.addr = &(((_arg2_chpl).addr)->_atomicVar_chpl);
  call_tmp_chpl2 = chpl_macro_tmp_5493;
  ...
  if (isdirect_chpl) {
    ...
    chpl_macro_tmp_5494.addr = tmp_chpl2;
    tmp_chpl3 = chpl_macro_tmp_5494;
    on_fn6(tmp_chpl, default_argorder_chpl, tmp_chpl3);
  } else {
    _args_foron_fn_chpl = ((_class_localson_fn6)(&chpl_macro_tmp_5495));
    ...
    tmp_chpl5 = &ret_chpl;
    chpl_macro_tmp_5496.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_5496.addr = tmp_chpl5;
    tmp_chpl6 = chpl_macro_tmp_5496;
  ...
  if (isdirect_chpl2) {
    ...
    chpl_macro_tmp_5497.addr = tmp_chpl7;
    tmp_chpl8 = chpl_macro_tmp_5497;
    on_fn7(tmp_chpl8, ret_chpl, default_argorder_chpl2);
  } else {
    _args_foron_fn_chpl2 = ((_class_localson_fn7)(&chpl_macro_tmp_5498));
    (_args_foron_fn_chpl2)->_0_rvfDerefTmp = call_tmp_chpl4;
    tmp_chpl9 = call_tmp_chpl;
    chpl_macro_tmp_5499.locale = chpl_gen_getLocaleID();
    chpl_macro_tmp_5499.addr = tmp_chpl9;
    tmp_chpl10 = chpl_macro_tmp_5499;
