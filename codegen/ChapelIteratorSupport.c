...
static void chpl___ASSIGN_6(_ref__ir_blk__ref__array_DefaultRectangularArr__remoteAccessData_Bitmap_1_int64_t_F_F_1_int64_t_F_int64_t ic,
  ...
  chpl____wide__ref__wide_DefaultRectangularDom_1_int64_t_F chpl_macro_tmp_600;
  chpl____wide__ref__wide__ddata__remoteAccessData_Bitmap_1_int64_t_F_F chpl_macro_tmp_601;
  chpl____wide__ref__remoteAccessData_Bitmap_1_int64_t_F_F chpl_macro_tmp_602;
  chpl____wide__ref__tuple_1_star_int64_t chpl_macro_tmp_603;
  coerce_tmp = *(ic);
  ...
  this13 = ret;
  chpl_macro_tmp_600.locale = (&this13)->locale;
  chpl_macro_tmp_600.addr = &(((&this13)->addr)->dom);
  chpl_gen_comm_get(((void*)(&coerce_tmp2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_600).locale), INT64(0), INT32(0)), (chpl_macro_tmp_600).addr, sizeof(chpl____wide_DefaultRectangularDom_1_int64_t_F), -1, COMMID(0), INT64(92), INT64(16));
  ...
  chpl_macro_tmp_601.locale = (&info)->locale;
  chpl_macro_tmp_601.addr = &(((&info)->addr)->shiftedData);
  chpl_gen_comm_get(((void*)(&coerce_tmp3)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_601).locale), INT64(0), INT32(0)), (chpl_macro_tmp_601).addr, sizeof(chpl____wide__ddata__remoteAccessData_Bitmap_1_int64_t_F_F), -1, COMMID(1), INT64(92), INT64(16));
  for (i = call_tmp2; ((i <= _ic__F1_high)); i += _ic__F2_stride) {
    chpl_macro_tmp_602.locale = (&coerce_tmp3)->locale;
    chpl_macro_tmp_602.addr = ((&coerce_tmp3)->addr + i);
    call_tmp6 = chpl_macro_tmp_602;
    chpl_macro_tmp_603.locale = (call_tmp6).locale;
    chpl_macro_tmp_603.addr = &(((call_tmp6).addr)->blk);
    e = chpl_macro_tmp_603;
...
static void chpl___ASSIGN_5(_ref__ir_blk__ref__array_DefaultRectangularArr__remoteAccessData__array_DefaultRectangularArr_FCHGlobalNode_1_int64_t_F_int64_t_1_int64_t_F_F_1_int64_t_F_int64_t ic,
  ...
  chpl____wide__ref__tuple_1_star_int64_t e = {CHPL_LOCALEID_T_INIT, NULL};
  chpl____wide__ref__wide_DefaultRectangularDom_1_int64_t_F chpl_macro_tmp_604;
  chpl____wide__ref__wide__ddata__remoteAccessData__array_DefaultRectangularArr_FCHGlobalNode_1_int64_t_F_int64_t_1_int64_t_F_F chpl_macro_tmp_605;
  chpl____wide__ref__remoteAccessData__array_DefaultRectangularArr_FCHGlobalNode_1_int64_t_F_int64_t_1_int64_t_F_F chpl_macro_tmp_606;
  chpl____wide__ref__tuple_1_star_int64_t chpl_macro_tmp_607;
  coerce_tmp = *(ic);
  T2 = (&coerce_tmp)->F0_this;
  T = T2;
  this12 = T;
  ret = (&this12)->_instance;
  this13 = ret;
  chpl_macro_tmp_604.locale = (&this13)->locale;
  chpl_macro_tmp_604.addr = &(((&this13)->addr)->dom);
  chpl_gen_comm_get(((void*)(&coerce_tmp2)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_604).locale), INT64(0), INT32(0)), (chpl_macro_tmp_604).addr, sizeof(chpl____wide_DefaultRectangularDom_1_int64_t_F), -1, COMMID(3), INT64(92), INT64(16));
  _ic__F1_viewDom = coerce_tmp2;
  info = ret;
  call_tmp2 = dsiLow(coerce_tmp2);
  call_tmp3 = dsiLow(_ic__F1_viewDom);
  ...
  _ic__F1_high = ((int64_t)((call_tmp2 + ((int64_t)((((int64_t)((call_tmp5 - INT64(1)))) * call_tmp4))))));
  _ic__F2_stride = call_tmp4;
  chpl_macro_tmp_605.locale = (&info)->locale;
  chpl_macro_tmp_605.addr = &(((&info)->addr)->shiftedData);
  chpl_gen_comm_get(((void*)(&coerce_tmp3)), chpl_nodeFromLocaleID(&((chpl_macro_tmp_605).locale), INT64(0), INT32(0)), (chpl_macro_tmp_605).addr, sizeof(chpl____wide__ddata__remoteAccessData__array_DefaultRectangularArr_FCHGlobalNode_1_int64_t_F_int64_t_1_int64_t_F_F), -1, COMMID(4), INT64(92), INT64(16));
  for (i = call_tmp2; ((i <= _ic__F1_high)); i += _ic__F2_stride) {
    chpl_macro_tmp_606.locale = (&coerce_tmp3)->locale;
    chpl_macro_tmp_606.addr = ((&coerce_tmp3)->addr + i);
    call_tmp6 = chpl_macro_tmp_606;
    chpl_macro_tmp_607.locale = (call_tmp6).locale;
    chpl_macro_tmp_607.addr = &(((call_tmp6).addr)->blk);
    e = chpl_macro_tmp_607;
